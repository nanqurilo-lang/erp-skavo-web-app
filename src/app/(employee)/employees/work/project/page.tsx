                        ...
                        <div className="w-1/2">
                          ...
                          <div className="mt-2">
                            <div className="relative bg-gray-200 h-4 rounded-full overflow-hidden">
                              <div
                                className={`h-4 rounded-full ${getProgressColor(ucProgress)}`}
                                style={{
                                  width: `${Math.max(0, Math.min(100, ucProgress))}%`,
                                }}
                              />
      ...
      <TableRow key={p.id} className="bg-white hover:bg-gray-50">
        ...
        <TableCell className="py-4 px-4 align-top">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              <button
                className={`inline-flex items-center gap-2 px-2 py-1 rounded-full text-xs ${statusBadgeClas(p.projectStatus)}`}
        ...
        <TableCell className="py-4 px-4 align-top text-right">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem
                onClick={() =>
                  window.location.assign(`/employees/work/project/${p.id}`)
                }
              >
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div
        ...
        className={`fixed inset-0 transition-opacity duration-300 z-[9990] ${showFilters ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
